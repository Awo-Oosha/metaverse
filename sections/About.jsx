  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      <motion.p
        ...
        className="mt-[8px] font-normal sm:text-[22px] text-[20px] text-center text-secondary-white "
      >
        ...
        real, you can feel what you feel in this metaverse world, because
        this is really the
        ...
        the metaverse world you want,
        turn your dreams into reality. Let's <span className="font-extrabold text-white"> explore </span> the madness of the
